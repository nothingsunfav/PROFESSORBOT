...
PICS = (environ.get('PICS', 'https://files.catbox.moe/htuku7.jpg')).split() 
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003041305681').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002947030944'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003081386721'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002915524449'))  
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002983924708') 
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002947030944'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003041305681'))
...
SHORTENER_API = environ.get("SHORTENER_API", "cde078e8aac997549c3476b34d43bf8e0484e061")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "gplinks.com")

SHORTENER_API2 = environ.get("SHORTENER_API2", "cde078e8aac997549c3476b34d43bf8e0484e061")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "gplinks.com")

SHORTENER_API3 = environ.get("SHORTENER_API3", "cde078e8aac997549c3476b34d43bf8e0484e061")
...
MSG_ALRT = environ.get('MSG_ALRT', 'leoyagami⚡🤍')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+h_ijq2C_fjJiZmQ1') 
